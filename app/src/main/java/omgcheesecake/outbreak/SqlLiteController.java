...
public class SqlLiteController {
    ...
    SqlLiteController(Context context){
    ...
    public void dateBeforeConversion(String date){
        Calendar calendar = Calendar.getInstance(Locale.getDefault());

        if (date.contains("1 Week")){
            calendar.add(Calendar.DAY_OF_MONTH, -7);
        }

        else if (date.contains("1 Month")){
            calendar.add(Calendar.MONTH, -1);
        }
        else if (date.contains("3 Month")){
            calendar.add(Calendar.MONTH, -3);
        }
        else if (date.contains("6 Month")){
            calendar.add(Calendar.MONTH, -6);
        }
        else if (date.contains("1 Year")){
